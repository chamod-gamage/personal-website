          ...
          <Col lg={9}>
            <Row style={{ textAlign: "left", paddingTop: 0 }}>
              <intro>
                ...
                <br />
                <em>
                  I'm currently looking for Summer 2021 internships in software
            ...
            <Row>
              ...
              <Col lg>
                <SydeSlider
                  ...
                  marks={[{ label: "2A", value: 3 }]}
                  step={null}
                  aria-label="Chamod is currently in his 2A term. Also, this website will be made fully accessible in the future."
                  defaultValue={3}
                />
                {/* </Row> */}
